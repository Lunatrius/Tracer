...
[Compile Tracer](#compile-tracer)

[Updating Your Repository](#updating-your-repository)

#### Setup Java
The Java JDK is used to compile Tracer.
...
#### Setup Git
Git is used to clone Tracer and update your local copy.
...
2. Navigate to a place where you want to download Tracer's source (eg `C:\Development\Github\Minecraft\`) by executing `cd [folder location]`. This location is known as `mcdev` from now on.
3. Execute `git clone git@github.com:Lunatrius/Tracer.git`. This will download Tracer's source into `mcdev`.
4. Right now, you should have a directory that looks something like:

***
    mcdev
    \-Tracer
        \-Tracer's files (should have build.gradle)
***

#### Compile Tracer
1. Execute `gradlew setupDevWorkspace`. This sets up Forge and downloads the necessary libraries to build Tracer. This might take some time, be patient.
...
3. Go to `mcdev\Tracer\build\libs`.
    * You should see a `.jar` file named `Tracer-#.#.#-#.#.#.#-universal.jar`.
